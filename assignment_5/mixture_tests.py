...
class GMMTests(unittest.TestCase):
    ...
    #
    #
    #     initial_means=np.array([[0.90980393, 0.8392157, 0.65098041],
    #                                 [0.83137256, 0.80784315, 0.69411767],
    #                                 [0.67450982, 0.52941179, 0.25490198],
    #                                 [0.86666667, 0.8392157, 0.70588237], [0, 0, 0],
    #                                 [0.8392157, 0.80392158, 0.63921571]])
    ...
    #     #print likelihood_diff,best_likelihood, ref_likelihood
    ...
    #     diff_thresh = 5e3
    #     #print improved_likelihood,original_likelihood
    ...
    #     image_matrix = image_to_matrix(image_file)
    #     num_components = 3
    #     initial_means = np.array([0.87451, 0.0019607, 0.109745])
    #
    ...
    #     print new_convergence_likelihood, default_convergence_likelihood,convergence_diff
    #
    ...
    def test_BIC_question(self):
        pairs=  BIC_likelihood_question()
        print pairs
